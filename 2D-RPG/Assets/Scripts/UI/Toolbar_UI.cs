...
public class Toolbar_UI : MonoBehaviour
{
    ...
    {
        return selectedSlot != null && selectedSlot.inventorySlot != null ? selectedSlot.inventorySlot.itemName : "";
    }
...
public void SelectSlot(int index)
{
    if (toolbarSlots.Count == 9)
    {
        ...
        // inventorySlot yerine slot kullanıyoruz
        if (selectedSlot.inventorySlot != null)
        {
            Debug.Log("Selected item: " + selectedSlot.inventorySlot.itemName); // İtemin adını burada görebilirsiniz
        }
